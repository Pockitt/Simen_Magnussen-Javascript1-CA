...
export const heading1Home = `<h2 class="collection-game-pics">New Releases</h2>`;
export const heading2Home = `<h2 class="collection-game-pics">On Sale</h2>`;
export const heading3Home = `<h2 class="collection-game-pics">Fan Favourites</h2>`;
